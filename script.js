...
function display(operation) {
  ...
  // operation = operation.replaceAll("/", "÷");
  // I cannot use the above methods because they are not working on old iphone devices so i am using this code instead
  operation = operation.split("");
  while (operation.indexOf("*") !== -1 || operation.indexOf("/") !== -1) {
